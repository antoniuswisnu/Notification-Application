...
public class MainActivity extends AppCompatActivity {
    ...
    private NotificationCompat.Builder getNotificationBuiler(){
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("MISI PAKET")
                .setContentText("IPHONE 14 KAMU SUDAH DATANG")
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(), R.drawable.aji2);
        ...
        notifyBuilder.setStyle(new NotificationCompat.BigPictureStyle()
                ...
                .setBigContentTitle("IPHONE KAMU TELAH DIRAMPAS"));
